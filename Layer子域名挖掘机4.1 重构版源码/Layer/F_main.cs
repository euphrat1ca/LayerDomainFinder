...
namespace Layer
{
    public partial class F_main : Form
    {
        ...
        {
            LV_result.Columns[1].Width = LV_result.Width - LV_result.Columns[0].Width - LV_result.Columns[2].Width - LV_result.Columns[3].Width - 30;
            ...
            if (LV_result.Items.Count > 0)
            {
                ...
                if (save_path.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        foreach (ListViewItem item in LV_result.Items)
                        {
                            list += item.SubItems[0].Text +"\t"+ item.SubItems[1].Text + "\t" + item.SubItems[2].Text + "\r\n";
                        }
                        File.WriteAllText(save_path.FileName, list);
